CREATE OR REPLACE PACKAGE BODY TABLEROS_PKG AS
    ...
    PROCEDURE CREAR_TABLERO_PR(P_ID_TABLERO NUMBER, P_JUGADOR_1 VARCHAR2(25), P_JUGADOR_2 VARCHAR2(25)) IS
    ...
    PROCEDURE INICIALIZAR_LETRA_PR(P_ID_TABLERO NUMBER, P_ID_LETRA VARCHAR2(1), P_CANTIDAD NUMBER) IS
    ...
    PROCEDURE AGREGAR_BONUS_PR(P_ID_TABLERO NUMBER, P_X NUMBER, P_Y NUMBER, P_BONUS VARCHAR2(2)) IS
